...
export const OPENAI_CONFIG = {
  ...
  investmentAnalysisModel: 'HCX-005',  // 투자 분석용 고급 모델
...
**주의사항:**
- 반드시 제공된 기업 목록에서만 선택하세요. 투자 전략을 위한 3가지 기업(두 전략이므로 총 6개)을 선택해야합니다.
- 정통한 전략: 안정적이고 검증된 투자 접근법
- 창의적 전략: 혁신적이고 미래 지향적인 투자 접근법
- 각 기업의 추천 이유를 구체적으로 설명하세요
- 한국어로 친근하게 답변하되 전문성을 유지하세요` as const;

                              ...
                              <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200">
                                  <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                      <h3 className="text-sm font-semibold text-slate-900">기술적 분석</h3>
                                      <p className="text-xs text-slate-600">차트 패턴 분석</p>
                                    </div>
                                  </div>
                                ...
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200">
                                  <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                      <h3 className="text-sm font-semibold text-slate-900">산업 분석</h3>
                                      <p className="text-xs text-slate-600">업종 비교 분석</p>
                                    </div>
                                  </div>
                                ...
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200">
                                  <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                      <h3 className="text-sm font-semibold text-slate-900">시장 분석</h3>
                                      <p className="text-xs text-slate-600">시장 동향 분석</p>
                                    </div>
                                  </div>
                                  <div className="w-5 h-5 rounded-full bg-yellow-500 shadow-lg shadow-yellow-500/50"></div>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200">
                                  <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                      <h3 className="text-sm font-semibold text-slate-900">리스크 분석</h3>
                                      <p className="text-xs text-slate-600">변동성 측정</p>
                                    </div>
                                  </div>
                                  <div className="w-5 h-5 rounded-full bg-red-500 shadow-lg shadow-red-500/50"></div>
                                </div>
